...
const INPUT_KEY_LABELS: Record<string, string> = {
  ...
  dataUdienzaIstruttoriaRicorso: "data udienza istruttoria ricorso",
  dataUdienzaConclusioniRicorso: "data udienza conclusioni ricorso",
  dataProvvedimentoTerminiRitoSemplificato: "provvedimento del giudice (rito semplificato)",
